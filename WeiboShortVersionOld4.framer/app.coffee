...
homePageContent =(content) ->
	...
	for i in [0...2]
		...
		if i < 1
			...
			layer.y = 116 + homePageItem[0].height + layerGap - 42
...
# 		homeTitle.scale = Utils.modulate(page.content.x, [-375 + 187.5, -375], [1.02, 1])
	if page.content.x <= a && page.content.x >= b
		tabColorPad.x = -64
		tabMask.x = 178-4
		hotTitle.fontWeight = 600
		...
		nearbyTitle.opacity = Utils.modulate(page.content.x, [c,d], [0.75, 1])
